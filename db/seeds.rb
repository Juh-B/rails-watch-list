...
print 'Deleting pre-existing Bookmarks...'
Bookmark.destroy_all
print 'Deleting pre-existing Movies...'
Movie.destroy_all
print 'Deleting pre-existing Lists...'
List.destroy_all
puts 'Deleted!'
...
top_movies['results'].each do |movie|
  ...
  poster_url = "https://image.tmdb.org/t/p/w450#{movie['poster_path']}"
